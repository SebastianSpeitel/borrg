...
impl AsRef<str> for Zstd {
    ...
    fn as_ref(&self) -> &str {
        match *self {
            ...
            Self::Level8 => "zstd,8",
            Self::Level9 => "zstd,9",
            Self::Level10 => "zstd,10",
            Self::Level11 => "zstd,11",
            Self::Level12 => "zstd,12",
            Self::Level13 => "zstd,13",
            Self::Level14 => "zstd,14",
            Self::Level15 => "zstd,15",
            Self::Level16 => "zstd,16",
            Self::Level17 => "zstd,17",
            Self::Level18 => "zstd,18",
            Self::Level19 => "zstd,19",
            Self::Level20 => "zstd,20",
            Self::Level21 => "zstd,21",
            Self::Level22 => "zstd,22",
        }
    }
}
